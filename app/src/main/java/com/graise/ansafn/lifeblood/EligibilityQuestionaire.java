...
import com.graise.ansafn.lifeblood.DTO.EligibilityQuestion;
...
public class EligibilityQuestionaire extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.eligibility_questionaire);
        ...
        findViewById(R.id.btnyes).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(EligibilityQuestionaire.this, ExistingDonor.class);
    ...
    class GetData extends AsyncTask<String, Void, String> {
        ...
        ProgressDialog pd = new ProgressDialog(EligibilityQuestionaire.this);
